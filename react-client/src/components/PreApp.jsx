...
//             <p>
//               Your source of truth, from diet to workouts. We have got your
//               bases covered.
//             </p>
//             <Link to="/">
//               Learn More
...
//                 the three major (or macro) nutrients: protein, carbohydrates,
//                 and fat. Rather than placing all of your attention on counting
...
//                 each macronutrient (and choosing quality sources), you can
//                 better tailor it to your lifestyle, tastes, and goals.
//               </p>
...
//                 focuses on macronutrients rather than calories. Macronutrients,
//                 or macros, are the four types of food molecules the body can
//                 break down for energy. Three types of macronutrients are tracked
//                 in IIFYM: Protein, which has 4 calories per gram. Carbohydrates,
...
//                 per gram, but it is not included in the IIFYM diet. Following
//                 the IIFYM diet is pretty simple, and only requires a few steps:
//                 Calculating your macros: Calculations are used to determine how
//                 many grams of protein, carbs and fat you need each day in order
//                 to meet your weight goals. Meeting your macros: Once you know
//                 your macros, you just need to stay within them each day. Food
//                 intake is tracked and adjusted as needed. Since all foods are
//                 allowed, many people consider this diet a welcome change from
//                 strict calorie counting or eliminating entire food groups.
//               </p>
